    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="space-y-3">
          <button
            onClick={reset}
            className="w-full py-3 px-4 bg-mavi-navy text-white rounded-xl font-semibold active:scale-95 transition-transform"
          >
            Tekrar Dene
          </button>
          <button
            onClick={() => router.push('/dashboard')}
            className="w-full py-3 px-4 bg-gray-100 text-gray-700 rounded-xl font-semibold active:scale-95 transition-transform"
          >
            Ana Sayfaya Dön
          </button>
        </div>
